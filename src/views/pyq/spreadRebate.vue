<template>
    <div class="tab-container">
        <el-tabs v-model="activeName" style="margin-top:15px;" type="border-card" @tab-click="handleClick">
            <el-tab-pane label="返利数据查询" name="first">
                <div class="app-container manage-container">
                    <filter-container
                        @submit-form="getSpreadRebatePage"
                    ...
                    <div class="manage-main">
                        <div class="manage-main-body">
                            ...
                            >
                                ...
                                <el-table-column align="center" label="总返利" width="200">
                                    <template slot-scope="scope">
                                ...
                                <el-table-column align="center" label="未领取返利" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.usUnreceivedNum }}
                                    </template>
                                </el-table-column>
                            </el-table>
                        </div>
            ...
            <el-tab-pane label="领取详情" name="second">
                <div class="app-container manage-container">
                    <filter-container
                        @submit-form="getSpreadReceivePage"
                        @reset-form="resetQueryParam"
                        @toggle-panel="handleFilterHandleButtonClick">
                        <template slot="form">
                            <el-form
                    ...
                    <div class="manage-main">
                        <div class="manage-main-body">
                            ...
                            >
                                ...
                                <el-table-column align="center" label="用户昵称" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.srNickName }}
                                    </template>
                                </el-table-column>

                                <el-table-column align="center" label="领取时间" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.srReceiveTime }}
                                    </template>
                                </el-table-column>

                                <el-table-column align="center" label="领取数量" width="400">
                                    <template slot-scope="scope">
                                        {{ scope.row.srReceivedNum }}
                                    </template>
                                </el-table-column>
                                <el-table-column align="center" label="累加领取数量" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.srCumulativeNum }}
                                    </template>
                                </el-table-column>
                            </el-table>
                        </div>
            ...
            <el-tab-pane label="充值返利查询" name="third">
                <div class="app-container manage-container">
                    <filter-container
                        @submit-form="getSpreadRechargePage"
                        @reset-form="resetQueryParam"
                        @toggle-panel="handleFilterHandleButtonClick">
                        <template slot="form">
                            <el-form
                    ...
                    <div class="manage-main">
                        <div class="manage-main-body">
                            ...
                            >
                                ...
                                <el-table-column align="center" label="充值时间" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.srReceiveTime }}
                                    </template>
                                </el-table-column>

                                <el-table-column align="center" label="返利数量" width="400">
                                    <template slot-scope="scope">
                                        {{ scope.row.srReceivedNum }}
                                    </template>
                                </el-table-column>
                                <el-table-column align="center" label="累加返利数量" width="200">
                                    <template slot-scope="scope">
                                        {{ scope.row.srCumulativeNum }}
                                    </template>
                                </el-table-column>
    ...
    export default {
        ...
        methods: {
            async getSpreadRebatePage () {
                ...
                spread.getSpreadRebatePage(self.currentPage, self.pageSize,self.searchUid, self.searchCode).then(result => {
            ...
            async getSpreadReceivePage () {
                ...
                self.listLoading = true
                spread.getSpreadReceivePage(self.currentPage, self.pageSize,self.searchUid, self.searchCode).then(result => {
                    self.listLoading = false
                    self.tableDatas = result.data.rows
                    self.listTotal = result.data.total
                }, result => {
            ...
            async getSpreadRechargePage () {
                ...
                self.listLoading = true
                spread.getSpreadRechargePage(self.currentPage, self.pageSize,self.searchUid, self.searchCode).then(result => {
                    self.listLoading = false
                    self.tableDatas = result.data.rows
                    self.listTotal = result.data.total
                }, result => {
            ...
            handleFilterHandleButtonClick: function (flag) {
                ...
                if (!flag) {
                    if (this.activeName=="first") {
                        this.getSpreadRebatePage()
                    } else if (this.activeName=="second") {
                        this.getSpreadReceivePage()
                    } else if (this.activeName=="third") {
                        this.getSpreadRechargePage()
                    }
                }
            },
