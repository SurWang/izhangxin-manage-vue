        ...
        <div class="manage-main">
            <div class="manage-main-body">
                ...
                >
                    ...
                    <el-table-column align="center" label="vip1总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level1Cnt }}
                        </template>
                    </el-table-column>

                    <el-table-column align="center" label="vip2购买总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.buyLevel2Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip2兑换总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.excLevel2Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip2总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level2Sum }}
                        </template>
                    </el-table-column>

                    <el-table-column align="center" label="vip3购买总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.buyLevel3Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip3兑换总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.excLevel3Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip3总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level3Sum }}
                        </template>
                    </el-table-column>

                    <el-table-column align="center" label="vip4购买总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.buyLevel4Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip4兑换总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.excLevel4Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip4总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level4Sum }}
                        </template>
                    </el-table-column>

                    <el-table-column align="center" label="vip5购买总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.buyLevel5Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip5兑换总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.excLevel5Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip5总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level5Sum }}
                        </template>
                    </el-table-column>

                    <el-table-column align="center" label="vip6购买总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.buyLevel6Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip6兑换总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.excLevel6Cnt }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="vip6总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.level6Sum }}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column align="center" label="所有总数" width="100">
                        <template slot-scope="scope">
                            {{ scope.row.vipSum }}
                        </template>
                    </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            async getVipStaticsPage () {
                ...
                vipPrice.getVipStaticsPage(self.currentPage, self.pageSize, self.searchType, self.startDate,
                    self.endDate).then(result => {
