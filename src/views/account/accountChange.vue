<template>
    <div class="app-container manage-container">
        <filter-container
            @submit-form="getAccountChangePage"
                ...
                <el-form
                    ...
                    <el-form-item class="filter-form-item" label="用户UID">
                        <el-input size="small"
                                  ...
                                  style="width: 200px;"
                                  clearable
                                  @keydown.prevent.enter.native="getAccountChangePage">
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item class="filter-form-item" label="输赢条件">
                        <el-select
                            size="small"
                            v-model="searchWl"
                            popper-class="role-select-dropdown"
                            style="width: 200px"
                        >
                            <el-option class="role-select-dropdown__item" value="0" label="全部"></el-option>
                            <el-option class="role-select-dropdown__item" value="1" label="赢"></el-option>
                            <el-option class="role-select-dropdown__item" value="-1" label="输"></el-option>
                        </el-select>
                    </el-form-item>

                    <el-form-item class="filter-form-item" label="其他参数">
                        <el-input size="small"
                                  v-model="searchParam"
                                  placeholder="其他参数"
                                  style="width: 200px;"
    ...
    export default {
        ...
        methods: {
            async getAccountChangePage () {
                ...
                account.getAccountChangePage(self.currentPage, self.pageSize,self.searchUid, self.searchReason,
                    self.searchGame, self.searchServer, self.searchType, self.searchWl, self.searchParam,
